...
namespace _11_01ArraysVsMoreAdvancedCollections
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Create an Array type colection of Animal" + "object and use it:");
            ...
            Console.WriteLine("Arrays collection contains {0} objects",
                animalArray.Length);
            animalArray[0].Feed();
            ...
            {
                Console.WriteLine("New {0} ojbect added to ArrayList collection," +
                                  " Name = {1}", myAnimal.ToString(), myAnimal.Name);
            }
